    ...
    <section className='videosect'>
        <div className="container">
            ...
            <div className="videocards">
                <div className='samir' style={{display:"flex",alignItems:"center",justifyContent:"center", gap:"15px",width:"100%",marginBottom:"10px"}}>
            ...
            <p>soundcloud</p>
                ...
                <div className='samir' style={{display:"flex",alignItems:"center",justifyContent:"center", gap:"15px",width:"100%"}}>
